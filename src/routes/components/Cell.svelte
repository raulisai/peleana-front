...
{:else}
	<button
		...
		class="cell border bg-gradient-to-br from-gray-300 to-white border-gray-500 w-14 h-14 p-2 flex items-center justify-center transform hover:scale-105 transition-transform duration-300"
	>
